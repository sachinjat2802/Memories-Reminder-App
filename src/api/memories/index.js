...
const { createMemory, updateMemory, getAllMemories, getAMemory, getAllMemoriesSorted, searchMemory, getTagsSuggestion, deleteMemory } = require("./memory-controller");
...
router.delete("/:id", authorizationService.authenticateUser, deleteMemory);
